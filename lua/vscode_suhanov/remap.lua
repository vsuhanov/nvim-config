...
keymap('n', '<leader>aa', function() vscode.call('vscode-harpoon.addEditor') end, opts)
keymap('n', '<leader>ae', function() vscode.call('vscode-harpoon.editEditors') end, opts)
keymap('n', '<leader>ee', function() vscode.call('vscode-harpoon.editorQuickPick') end, opts)
