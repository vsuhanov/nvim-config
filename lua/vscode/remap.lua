...
vim.keymap.set("v", "<leader>tb", function() vscode.call("editor.debug.action.toggleBreakpoint") end, opts)
vim.keymap.set("v", "<leader>tt", function() vscode.call("workbench.action.tasks.reRunTask") end, opts)
