...
vim.keymap.set({ "n" }, "<leader>nt", ":vs | term<cr>", { silent = true })
vim.keymap.set({ "n" }, "<leader>Nt", ":sp | term<cr>", { silent = true })
vim.keymap.set({ "n" }, "<leader>nT", ":tabnew | term<cr>", { silent = true })
vim.keymap.set({ "c" }, "<C-p>", "<C-r>=escape(@+, ' ')<cr>", { silent = true, noremap=true })
