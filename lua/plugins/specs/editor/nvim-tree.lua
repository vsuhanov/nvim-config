...
return {
  ...
  opts = {
    ...
    on_attach = function(bufnr)
      ...
      vim.keymap.set("n", "E",require('nvim-tree.api').tree.expand_all, opts("Expand All"))
      ...
      vim.keymap.set("n", "M",require('nvim-tree.api').tree.toggle_no_bookmark_filter, opts("Toggle Filter: No Bookmark"))
