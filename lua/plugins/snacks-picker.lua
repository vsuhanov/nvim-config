...
vim.keymap.set("n", "<leader>gc", function() snacks.picker.git_commits() end, opts)
vim.keymap.set("n", "<leader>gbc", function() snacks.picker.git_commits({ buf = 0 }) end, opts)
vim.keymap.set("v", "<leader>gbl", function() snacks.picker.git_commits({ buf = 0, range = true }) end, opts)
